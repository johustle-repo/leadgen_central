...
| app/Services/{DashboardReport,DatabaseIntelligenceReport}.php,resources/js/pages/{dashboard,analytics/index}.tsx | .ai/rules/pages.md |
| app/{Http/Controllers,Http/Requests,Models}/**/*LeadAttachment*.php | .ai/rules/requests-models.md |
| routes/console.php | .ai/rules/scheduler.md |
