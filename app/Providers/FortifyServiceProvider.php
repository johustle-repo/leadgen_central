...
use App\Actions\Fortify\EnsureSingleAgentSession;
...
class FortifyServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Fortify::authenticateUsing(function (Request $request): ?User {
            ...
            return $user !== null && $user->status === AccountStatus::Active && Hash::check((string) $request->password, $user->password) ? $user : null;
        });
    }
    ...
    private function configureAuthenticationPipeline(): void
    {
        Fortify::authenticateThrough(fn (Request $request): array => array_filter([
            ...
            EnsureSingleAgentSession::class,
