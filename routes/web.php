...
Route::middleware(['auth', 'auth.session', 'verified', 'active'])->group(function () {
    ...
    Route::get('leads/{lead}/attachments/{leadAttachment}', [LeadAttachmentController::class, 'download'])->name('leads.attachments.download');
    Route::delete('leads/{lead}/attachments/{leadAttachment}', [LeadAttachmentController::class, 'destroy'])->name('leads.attachments.destroy');
    ...
    Route::delete('users/{user}/records', [UserController::class, 'clearRecords'])->name('users.records.clear');
    ...
    Route::middleware('can:manage-attendance')->group(function () {
        ...
        Route::put('attendance/{user}/{date}/{entryType}', [AttendanceController::class, 'updateEntry'])->whereIn('entryType', ['time_in', 'time_out'])->name('attendance.update-entry');
    });
});
